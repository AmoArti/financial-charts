// src/components/ChartGrid.tsx (Expand-Icon Farbe angepasst)
...
const ChartGrid: React.FC<ChartGridProps> = ({
  ...
  const renderHeaderContent = (title: string, onExpandClick: () => void, chartKey: string) => (
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
      ...
      {/* NEU: color="dark" hinzugefügt */}
      <IonButton fill="clear" color="dark" onClick={onExpandClick} style={{ flexShrink: 0 }} aria-label={`Expand ${title}`}>
